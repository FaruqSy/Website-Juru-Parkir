			...
			<div class="sidebar">
				...
				<nav class="mt-2">
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						...
						<li class="nav-item">
							<a href="?page=data-rambu" class="nav-link">
          ...
          switch ($hal) {
              //Klik Halaman Home Pengguna
				...
				case 'view-pegawai':
					...
					break;
				case 'data-rambu':
					include "admin/pegawai/data_rambu.php";
					break;
				case 'add-rambu':
					include "admin/pegawai/add_rambu.php";
					break;
				case 'edit-rambu':
					include "admin/pegawai/edit_rambu.php";
					break;
				case 'del-rambu':
					include "admin/pegawai/del_rambu.php";
					break;
				case 'view-rambu':
					include "admin/pegawai/view_rambu.php";
					break;
    ...
    ?>
		...
		<footer class="main-footer">
			<div class="float-right d-none d-sm-block">
				Copyright &copy;
				<a target="_blank" href="https://perhubungan.madiunkab.go.id/">
					<strong> Dinas Perhubungan Kabupaten Madiun</strong>
				</a>
				All rights reserved.
			</div>
			<b>Created 2022</b>
