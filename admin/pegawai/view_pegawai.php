		...
		<div class="card card-info">
			...
			<div class="card-body p-0">
				...
				<div class="card-footer">
					...
					<a href="./report/cetak-pdf.php?id=<?php echo $data_cek['id']; ?>" target=" _blank"
					 title="Cetak Data Pegawai" class="btn btn-success">Print pdf all files</a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="card card-success">
			...
			<div class="card-body">
				<div class="text-center">
					<img src="foto/<?php echo $data_cek['foto']; ?>" width="300px" />
				</div>
